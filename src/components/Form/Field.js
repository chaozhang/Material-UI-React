...
const Field = (props) => {
    ...
    const {
        ...
        // This is for the select type
        multiple,
        options,

        // This if for file type specifically
        contentType,
        handleChange,

        // This is the catch-all for generic properties
        ...other,
    } = field;
    ...
    if (type == 'file') {
        ...
        return (
            <FormikField
                ...
                name={name}
                type={type || 'text'}
                render={props => <Input {...props.form} type={type} {...field} />}
                value={values[name]}
                {...other}
            />
